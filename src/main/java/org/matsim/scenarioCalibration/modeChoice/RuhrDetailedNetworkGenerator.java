...
public class RuhrDetailedNetworkGenerator {
    ...
    public static void main(String[] args) {
        ...
        String osmfile = "data/matsim_input/zz_archive/network/allWaysNRW/allWaysNRW.osm";
        List<String> inputCountNodeMappingFiles = Arrays.asList(
                "data/matsim_input/zz_archive/counts/mapmatching/OSMNodeIDs_Dauerzaehlstellen.csv",
                "data/matsim_input/zz_archive/counts/mapmatching/Nemo_kurzfristZaehlstellen_OSMNodeIDs_UTM33N-allStationsInclNotFound.csv");
        String epsg = NEMOUtils.NEMO_EPSG;
        String prefix = "detailedRuhr_Network_" + new SimpleDateFormat("ddMMyyyy").format(new Date());
        String outDir = "data/matsim_input/2018-02-27_RuhrDetailedNet_unCleaned/";
        String shapeFile = "data/original_files/shapeFiles/shapeFile_Ruhrgebiet/ruhrgebiet_boundary.shp";
