...
public class NemoLongTermCountsCreator {
    ...
    protected void finish(Map<String, Counts<Link>> countsPerColumnCombination) {
        ...
        for (String combination : this.columnCombination) {
            ...
            java.util.Iterator it = countsPerColumnCombination.get(combination).getCounts().values().iterator();
    ...
    public static class Builder extends AbstractBuilder<NemoLongTermCountsCreator> {
