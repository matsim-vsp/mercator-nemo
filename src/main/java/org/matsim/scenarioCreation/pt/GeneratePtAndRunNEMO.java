...
public class GeneratePtAndRunNEMO {
	...
	public void run() {
		...
		final String gtfsZipFile = projectDirectory + "data/pt/google_transit_vrr_2018_05_11_corrected-v3.zip"; 
		final String directory = projectDirectory + "data/pt/corrected-gtfs-file-v3/";
		...
		final String networkFileName = "detailedRuhr_Network_10072018filtered_network.xml.gz";
		final String initialNetworkFile = projectDirectory + "data/matsim_input/2018-05-28_shorterIntraZonalDist/" + networkFileName;
