...
public class GeneratePtAndRunNEMO {
	...
	public void run() {
		...
		final String gtfsZipFile = projectDirectory + "data/pt/google_transit_vrr_2018_05_11.zip"; 
		...
		final String directory = projectDirectory + "data/pt/original-gtfs-file/";
		
		// the data generated by the GTFS 2 MATSim converter
		final String networkGTFS = directory + "tertiaryNemo_10112017_EPSG_25832_filteredcleaned_network_GTFS.xml.gz";
		...
		final String networkGTFSadjusted = directory + "tertiaryNemo_10112017_EPSG_25832_filteredcleaned_network_GTFS_adjusted.xml.gz";
